export CUDA_VISIBLE_DEVICES=0,1,6,7  # 指定使用的GPU编号，如 0 或 1,2
...
# --resume_model /data/jzw/CLIP4Clip-master/ckpts/msvd/pytorch_opt.bin.0 \
# --init_model /data/jzw/CLIP4Clip-master/ckpts/msvd/pytorch_model.bin.0